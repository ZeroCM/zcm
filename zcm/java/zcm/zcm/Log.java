...
/**
 * A class for reading and writing ZCM log files.
 */
public class Log
{
    ...
    /**
     * Represents a single received ZCM message.
     */
    ...
    public synchronized void write(long utime, String channel, ZCMEncodable msg) throws IOException
    {
        Log.Event le = new Log.Event();
        le.utime = utime;
        le.channel = channel;
        ZCMDataOutputStream outs = new ZCMDataOutputStream();
        msg.encode(outs);
