...
/**
 * Accumulates received ZCM messages in a queue.
 * <p>
 * {@link ZCM} normally delivers messages asynchronously by invoking the
 * {@link ZCMSubscriber#messageReceived messageReceived}
...
//    Deque<Message> messages = new ArrayDeque<Message>();
    ...
    /**
     * Attempt to retrieve the next received ZCM message.
