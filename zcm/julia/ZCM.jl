...
cfunction.
"""
immutable SubscriptionOptions{T <: AbstractZCMType, F <: Function}
    msgtype::Type{T}
    handler::F
end
...
function subscribe(zcm::Zcm, channel::AbstractString, msgtype::Type{<:AbstractZCMType}, handler::Function)
