...
static int64_t __array_const_size1_hash;
...
int64_t __array_const_size1_hash_recursive(const __zcm_hash_ptr *p)
{
    ...
    int64_t hash = (int64_t)0xbb93d1c57076cddbLL
...
int64_t __array_const_size1_get_hash(void)
{
    if (!__array_const_size1_hash_computed) {
        __array_const_size1_hash = __array_const_size1_hash_recursive(NULL);
                            ...
                            const char *channel, void *userdata)
{
    ...
    status = array_const_size1_decode (rbuf->data, 0, rbuf->len, &p);
    if (status < 0) {
